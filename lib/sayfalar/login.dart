              ...
              StreamBuilder(
                ...
                builder: (context, snapshot) => TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      errorText: snapshot.error),
                  onChanged: _loginBloc.sifreChanged.add,
                ),
              ),
              SizedBox(
                height: 48.0,
    ...
    return Column(
      ...
      children: [
        ...
        FlatButton(
          ...
          onPressed: () => _loginBloc.loginOrCreateChanged.add('Hesap Oluştur'),
        )
      ],
    );
  }
      ...
      children: [
        StreamBuilder(
          ...
          builder: (context, snapshot) => RaisedButton(
            ...
            disabledColor: Colors.grey.shade100,
            onPressed: snapshot.data
                ? () => _loginBloc.loginOrCreateChanged.add('Hesap Oluştur')
                : null,
          ),
        )
      ],
